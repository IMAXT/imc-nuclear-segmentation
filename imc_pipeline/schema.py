...
segmentation = vo.Schema(
    {
        ...
        vo.Required("ref_channel_name"): vo.Coerce(str),
        ...
        vo.Optional("ain_automatic_image_normalization", default=True): bool,
        vo.Optional("ain_image_normalization_factor", default=1): vo.All(
